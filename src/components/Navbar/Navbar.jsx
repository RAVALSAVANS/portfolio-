    ...
    >
      <div className="flex items-center justify-between py-5 text-white">
        ...
        <div className="text-lg font-semibold cursor-pointer">
          ...
          <span className="text-white">Savan</span>
          <span className="text-[#8245ec]">/</span>
          <span className="text-white">Raval</span>
          <span className="text-[#8245ec]">&gt;</span>
        </div>
        ...
        <div className="hidden space-x-4 md:flex">
          <a
            href="https://github.com/RAVALSAVANS/"
            target="_blank"
          ...
          <a
            href=" https://linkedin.com/in/ravalsavans/ "
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-[#8245ec]"
          >
        ...
        <div className="absolute top-16 left-1/2 transform -translate-x-1/2 w-4/5 bg-[#050414] bg-opacity-50 backdrop-filter backdrop-blur-lg z-50 rounded-lg shadow-lg md:hidden">
          <ul className="flex flex-col items-center py-4 space-y-4 text-gray-300">
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="https://www.linkedin.com/in/sourav-kumar-a707ba280/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-white"
              >
