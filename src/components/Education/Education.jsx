...
const Education = () => {
  return (
    <section
      id="education"
      className="py-24 pb-24 px-[10vw] md:px-[4vw] lg:px-[0vw] font-sans bg-skills-gradient clip-path-custom-3"
    >
      {/* Section Title */}
      ...
      <div className="relative">
        ...
        {education.map((edu, index) => (
          ...
          >
            ...
            {/* Content Section */}
            <div
              className={`w-full sm:max-w-[448px] p-4 sm:p-8 rounded-2xl shadow-2xl border border-white bg-gray-900 backdrop-blur-md shadow-[0_0_20px_1px_rgba(130,69,236,0.3)] ${
