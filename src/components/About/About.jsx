...
const About = () => {
  return (
    <section
      id="about"
      className="py-4 px-[7vw] md:px-[7vw] lg:px-[12vw] font-sans mt-16 md:mt-24 lg:mt-10"
    >
          ...
          <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold mb-4 text-[#8245ec] leading-tight">
            ...
            <ReactTypingEffect
              ...
              cursorRenderer={(cursor) => (
                ...
                // “Typing effect ka cursor purple color ka ho.” -> | yeh
              )}
            />
          </h3>
          {/* About Me Paragraph */}
          <p className="mt-8 mb-10 text-base leading-relaxed text-gray-400 sm:text-lg md:text-lg">
            I'm a passionate Web Developer with expertise in React.js , wordpress and modern web technologies.<br/> I love creating beautiful and functional website that solve real world problems.
          </p>
          {/* Resume Button */}
          <a
            href="https://drive.google.com/file/d/169ymCsKBkf_9Wt34OIjdeKc9p-TESKZc/view?usp=drive_link"
            target="_blank"
